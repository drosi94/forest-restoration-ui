...
export const Preview = () => {
  ...
  const splitDisplayName = getValues('displayName')?.split(' ')

  const genderId = getValues('gender')
    ...
    <div tw="flex flex-col gap-6 items-center justify-center">
      ...
      <div tw="flex flex-col">
        <div tw="flex gap-1">
          ...
          {genderId === 'M' && <MaleIcon />}
          {genderId === 'F' && <FemaleIcon />}
        </div>

        <Typography fontSize="large">@{getValues('username')}</Typography>
      </div>
